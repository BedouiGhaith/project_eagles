...
public class MailAvis {
    ...
    String myAccount="nour.benali@esprit.tn";
   ...
   Message message=prepareMessage(session,myAccount,recepient,choice);
    ...
    private static Message prepareMessage(Session session,String myAccount,String recepient,int choice)
    {
        try {
            ...
            message.setFrom(new InternetAddress(myAccount,"keby"));
...
"</body></html>";
            ...
            Logger.getLogger(MailAvis.class.getName()).log(Level.SEVERE, null, ex);
