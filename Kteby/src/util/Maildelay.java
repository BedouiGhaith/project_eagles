...
public class Maildelay {
    ...
    String myAccount="mayssa.klay@esprit.tn";
    String password="213JFT4064";
...
"</body></html>";
            ...
            Logger.getLogger(Maildelay.class.getName()).log(Level.SEVERE, null, ex);
